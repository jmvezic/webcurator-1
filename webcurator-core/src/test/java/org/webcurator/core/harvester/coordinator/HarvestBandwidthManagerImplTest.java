...
//        when(mockBandwidthCalculator.calculateBandwidthAllocation(running, maxBandwidth, maxBandwidthPercent)).thenReturn(map);
        ...
        mockTargetInstanceDao.findTargetInstances(new TargetInstanceCriteria());
        mockBandwidthCalculator.calculateBandwidthAllocation(running, maxBandwidth, maxBandwidthPercent);
        mockHarvestAgentManager.restrictBandwidthFor(mockTargetInstance);
    }
